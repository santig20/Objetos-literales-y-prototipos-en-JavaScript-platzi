...
{
function escuelaJavascriptCarrera (alumno) {
  this.carreraycurso.push (ruta1.carrera);
}
function escuelaJavascriptCursos (alumno) {
  this.carreraycurso.push (ruta1.nameCursos);
}
}
;
